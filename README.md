...
**Barplot:** R script for creating a bar chart with omics data. For this repo, proteomics data generated inhouse was used to generate the bar plot with error bars to assess the precise measurement.
