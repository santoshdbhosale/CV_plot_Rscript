...
This repository (work in progress) will host a collection of R scripts used in prote(omics) analysis. Each folder includes following files to regenerate specific plot.
- R script
- Data frame template
- Figure
